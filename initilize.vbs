...
If fso.FileExists(DataFile) Then
	...
	Set oNotepad=oFS.OpenTextFile (DataFile, ForWriting, True)
Else
	Set oNotepad = fso.createtextfile(DataFile)
End If
Data = "N"&"|"&ClientName&"|"&ClientName & "_" & funGetTimeStamp()&"|"&"0"&"|"&SendNotificationsForTestCases&"|"&"0"&"|"&""&"|"&"0"&"|"&"0"&"|"&"0"&"|"&"0"&"|"&"0"&"|"&"0"
oNotepad.writeline Data
oNotepad.Close
